...
const UI_COPY: Record<string, readonly [string, string, string, string, string]> = {
  ...
  zoom: ["拡大", "Zoom", "放大", "放大", "확대"],
  originalImage: ["元の画像", "Original image", "原始圖片", "原图", "원본 이미지"],
  portrait: ["立ち絵", "Portrait", "立繪", "立绘", "캐릭터 일러스트"],
  previousImage: ["前の画像", "Previous image", "上一張", "上一张", "이전 이미지"],
  nextImage: ["次の画像", "Next image", "下一張", "下一张", "다음 이미지"],
  captureFailed: [
    "画像を保存できませんでした。読み込み後にもう一度お試しください。",
    "Could not save the image. Wait for the model to load and try again.",
    "無法儲存圖片，請在模型載入後重試。",
    "无法保存图片，请在模型加载后重试。",
    "이미지를 저장할 수 없습니다. 모델을 불러온 후 다시 시도하세요.",
  ],
  normalArt: ["特訓前", "Normal", "特訓前", "特训前", "특훈 전"],
  trainedArt: ["特訓後", "Trained", "特訓後", "特训后", "특훈 후"],
  image: ["画像", "Image", "圖片", "图片", "이미지"],
  ...
  partsVisibility: ["パーツ表示", "Parts visibility", "部件顯示", "部件显示", "파츠 표시"],
  customPoses: ["カスタムポーズ", "Custom poses", "自訂姿勢", "自定义姿势", "커스텀 포즈"],
  savePose: ["ポーズを保存", "Save pose", "儲存姿勢", "保存姿势", "포즈 저장"],
  defaultPose: ["デフォルトポーズ", "Default pose", "預設姿勢", "默认姿势", "기본 포즈"],
  rename: ["名前を変更", "Rename", "重新命名", "重命名", "이름 변경"],
  drag: ["ドラッグ移動", "Drag to move", "拖曳移動", "拖拽移动", "드래그 이동"],
  backgroundColor: ["背景色", "Background color", "背景色", "背景色", "배경색"],
  transparent: ["透過", "Transparent", "透明", "透明", "투명"],
  stop: ["停止", "Stop", "停止", "停止", "정지"],
  ...
  cardMovieGacha: ["ガチャアニメ", "Gacha movie", "抽卡動畫", "抽卡动画", "가챠 애니메이션"],
  cardMovieAnimated: ["アニメーションを再生", "Play animation", "播放動態", "播放动态", "애니메이션 재생"],
  cardMovieReplay: ["もう一度再生", "Replay", "重播", "重播", "다시 재생"],
